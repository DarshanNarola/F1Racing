...
.json(f"/mnt/adlsracingf1/raw/{v_file_date}/results.json")
...
#     deltaTable = DeltaTable.forPath(spark, "/mnt/adlracingf1/processed/results")
...
# MAGIC %sql
# MAGIC SELECT max(race_id), COUNT(*)
# MAGIC FROM f1_processed.results

# COMMAND ----------

spark.sql("DESCRIBE HISTORY hive_metastore.f1_processed.results").display()