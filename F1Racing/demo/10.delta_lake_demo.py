...
# MAGIC LOCATION '/mnt/adlsracingf1/demo'

# COMMAND ----------

results_df = spark.read \
.option("inferSchema", True) \
.json("/mnt/adlsracingf1/raw/2021-03-28/results.json")
...
results_df.write.format("delta").mode("overwrite").save("/mnt/adlsracingf1/demo/results_external")
...
# MAGIC USING DELTA
# MAGIC LOCATION '/mnt/adlsracingf1/demo/results_external'
...
results_external_df = spark.read.format("delta").load("/mnt/adlsracingf1/demo/results_external")
...
.option("inferSchema", True) \
.json("/mnt/adlsracingf1/raw/2021-03-28/drivers.json") \
.filter("driverId <= 10") \
...
deltaTable = DeltaTable.forPath(spark, "/mnt/    /demo/drivers_merge")
